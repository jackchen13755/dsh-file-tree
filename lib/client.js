...
function EditorView(props) {
    ...
    const body = (() => {
        ...
        if (!live) {
            return (0, react_1.createElement)('div', { style: S.center }, '编辑器未显示。');
        }
        if (!ready) {
    ...
    return (0, react_1.createElement)('div', { ref: attachRoot, style: S.root, 'data-dsh-file-tree-editor-root': '' }, (0, react_1.createElement)('div', { style: S.bar }, (0, react_1.createElement)('span', { style: { ...S.title, flex: '0 1 auto' } }, '编辑器'), (0, react_1.createElement)('span', { style: { ...S.hint, padding: 0, whiteSpace: 'nowrap' } }, instance?.version === undefined ? 'code-server' : `code-server ${instance.version}`), ready ? (0, react_1.createElement)('span', { style: { ...S.hint, padding: 0, color: TOKEN.ok } }, '● 就绪') : null, (0, react_1.createElement)('span', { style: S.spacer }), busy ? (0, react_1.createElement)('span', { style: { ...S.hint, padding: 0 } }, '处理中…') : null, ready
