...
function EditorTab(props) {
    ...
    return (0, react_1.createElement)('div', { style: { display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0 } }, (0, react_1.createElement)(editor_js_1.EditorView, {
        sessionId,
        initial: status,
        onStatus: setStatus,
    }));
...
function EditorView(props) {
    ...
    return (0, react_1.createElement)('div', { style: S.root, 'data-dsh-file-tree-editor-root': '' }, (0, react_1.createElement)('div', { style: S.bar }, (0, react_1.createElement)('span', { style: { ...S.title, flex: '0 1 auto' } }, '编辑器'), (0, react_1.createElement)('span', { style: { ...S.hint, padding: 0, whiteSpace: 'nowrap' } }, instance?.version === undefined ? 'code-server' : `code-server ${instance.version}`), ready ? (0, react_1.createElement)('span', { style: { ...S.hint, padding: 0, color: TOKEN.ok } }, '● 就绪') : null, (0, react_1.createElement)('span', { style: S.spacer }), busy ? (0, react_1.createElement)('span', { style: { ...S.hint, padding: 0 } }, '处理中…') : null, ready
        ...
        ? null
        : (0, react_1.createElement)('button', { style: S.iconButton, title: '关闭编辑器', onClick: onClose }, '✕')), body, ready && onClose !== undefined
